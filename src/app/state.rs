...
mod tests {
    ...
    fn contrast_ratio(first_color: Color, second_color: Color) -> f64 {
        let (lighter, darker) = {
            let first_luminance = rgb_luminance(first_color);
            let second_luminance = rgb_luminance(second_color);
            (
                first_luminance.max(second_luminance),
                first_luminance.min(second_luminance),
            )
        };
