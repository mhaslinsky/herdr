...
The developer-tooling question remains: what does a developer actually own? Is it the subscription, the API spend, the model access, or the runtime where the agent works?
